    ...
    <div className="relative">
      ...
      <Container className="relative">
        <Navbar
          banner={
            <Link
              href="/blog/MoveAi-raises-100m-series-a-from-tailwind-ventures"
        ...
        <div className="pt-16 pb-24 sm:pt-24 sm:pb-32 md:pt-32 md:pb-48">
          ...
          <br />
          <SpecialText>
            – Your Smart Contract Co-Pilot.
          </SpecialText>
          <p className="mt-8 max-w-lg text-xl/7 font-medium   sm:text-2xl/8">
            Build smart contracts effortlessly using our pre-audited templates, or analyze your existing ones for security vulnerabilities with our AI-powered super-agent.
          </p>
          <div className="mt-12 flex flex-col gap-x-6 gap-y-4 sm:flex-row">
            <Button className='bg-amber-500' href="#">Get started</Button>
      ...
      <Container>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
          <BentoCard
            ...
            description="Our MoveAiAI chat assistants analyze the sentiment of your conversations in real time, ensuring you're always one step ahead."
            graphic={
          ...
          <BentoCard
            ...
            description="MoveAiAI automatically writes LinkedIn posts that relate current events to B2B sales, helping you build a reputation as a thought leader."
            graphic={
