...
The Launchpad Module allows users to create fungible assets (FAs) with various configurations such as max supply, mint limits, and fees. It includes functionalities for admin control, FA creation, and minting events.

## Features
- **Admin Management:** Admins can set pending admins, accept admin roles, and update mint fee collectors.
- **FA Creation:** Supports creating FAs with configurable parameters.
- **Minting Control:** Includes mint limits per address and pre-minting options.
- **Event Logging:** Tracks FA creation and minting events.
